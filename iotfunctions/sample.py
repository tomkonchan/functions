...
class InputDataGenerator(BaseTransformer):
    ...
    def execute(self, df):
        raise ImportError(
            'Error in function catalog. InputDataGenerator was removed from samples. Use EntityDataGenerator.')
...
class TempPressureVolumeGenerator(BaseTransformer):
    ...
    def execute(self, df):
        raise ImportError(
            'Error in function catalog. TempPressureVolumeGenerator was removed from samples. Use EntityDataGenerator.')
